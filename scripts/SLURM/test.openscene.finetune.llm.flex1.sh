...
cd /gpfs/u/home/LMCG/LMCGljnn/scratch/zhy/pointbert
    ...
    --exp_name Exp0071_0709_HdWoAugBbox_FlexWarmUp3_FlexThreshold96_From[Scratch]_Epoch3 \
    --ckpt experiments/Adaptive-LLM-finetune-Openscene-FLEX-threshold-HD/MultiScale_models/Exp0071_0709_HdWoAugBbox_FlexWarmUp3_FlexThreshold96_From[Scratch]/ckpt-epoch-002.pth\
    --test 