...
cd /gpfs/u/home/LMCG/LMCGljnn/scratch/zhy/pointbert
    ...
    --launcher slurm \
    --sync_bn \
    --config cfgs/MultiScale_models/Adaptive-LLM-finetune-Openscene-256Token.yaml \
    --exp_name Exp0010_0613_LL3daData_TokenMask_AddPos_DetPrompt_FP32_SyBN_From[Scratch] \
    --resume