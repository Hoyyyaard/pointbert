...
cd /gpfs/u/home/LMCG/LMCGljnn/scratch/zhy/pointbert
    ...
    --launcher slurm \
    --sync_bn \
    --config cfgs/MultiScale_models/objectcentric/ObjectCentric-Adaptive-LLM-finetune-Openscene-FLEX-threshold-HD-AOE.yaml \
    --exp_name Exp0129_0804_RelativeToken_DenseObjectToken_ObjectCaptionWoVP_LeoModel_FlexWarmUp-1_Threshold127_From[Scratch] \
    --resume