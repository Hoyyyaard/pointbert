...
cd /gpfs/u/home/LMCG/LMCGljnn/scratch/zhy/pointbert
    ...
    --exp_name Exp0127_0804_RelativeToken_DenseObjectToken_ObjectCaptionWoVP_LeoModel_FlexWarmUp-1_Threshold127_From[Scratch]_Epoch4 \
    --ckpt experiments/ObjectCentric-Adaptive-LLM-finetune-Openscene-FLEX-threshold-HD/objectcentric/Exp0127_0804_RelativeToken_DenseObjectToken_ObjectCaptionWoVP_LeoModel_FlexWarmUp-1_Threshold127_From[Scratch]/ckpt-epoch-003.pth\
    --test 