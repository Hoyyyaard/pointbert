...
cd /gpfs/u/home/LMCG/LMCGljnn/scratch/zhy/pointbert
    $CMD  main_ALLM.py \
    --launcher slurm \
    --config cfgs/MultiScale_models/objectcentric/ObjectCentric-Adaptive-LLM-finetune-Openscene-test-FLEX-threshold-hm3dqa-AOE.yaml \
    --exp_name Exp0129_0804_RelativeToken_DenseObjectToken_ObjectCaptionWoVP_LeoModel_FlexWarmUp-1_Threshold127_From[Scratch]_Epoch4 \
    --ckpt experiments/ObjectCentric-Adaptive-LLM-finetune-Openscene-FLEX-threshold-HD-AOE/objectcentric/Exp0129_0804_RelativeToken_DenseObjectToken_ObjectCaptionWoVP_LeoModel_FlexWarmUp-1_Threshold127_From[Scratch]/ckpt-epoch-003.pth \
    --test 