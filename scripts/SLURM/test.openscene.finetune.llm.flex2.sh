...
cd /gpfs/u/home/LMCG/LMCGljnn/scratch/zhy/pointbert
    $CMD  main_ALLM.py \
    --launcher slurm \
    --config cfgs/MultiScale_models/Adaptive-LLM-finetune-Openscene-test-FLEX-threshold-hm3dqa1.yaml \
    --exp_name Exp0099_0711_WHdAugBbox_WoDiffPrompt_FlexWarmUp-1_FlexThreshold96_DenseTokenNum6_From[Scratch]_Epoch4 \
    --ckpt experiments/Adaptive-LLM-finetune-Openscene-FLEX-threshold-HD/MultiScale_models/Exp0099_0711_WHdAugBbox_WoDiffPrompt_FlexWarmUp-1_FlexThreshold96_DenseTokenNum6_From[Scratch]/ckpt-epoch-003.pth \
    --test 