...
cd /gpfs/u/home/LMCG/LMCGljnn/scratch/zhy/pointbert
    ...
    --exp_name Exp0085_0714_WoRscanQA_WHdAugBbox_DiffPrompt_FlexWarmUp-1_FlexThreshold96_From[Scratch]_Epoch5 \
    --ckpt experiments/Adaptive-LLM-finetune-Openscene-Extend-HD/MultiScale_models/Exp0085_0714_WoRscanQA_WHdAugBbox_DiffPrompt_FlexWarmUp-1_FlexThreshold96_From[Scratch]/ckpt-epoch-004.pth\
    --test 