...
cd /gpfs/u/home/LMCG/LMCGljnn/scratch/zhy/pointbert
    ...
    --launcher slurm \
    --sync_bn \
    --config cfgs/MultiScale_models/nuscenes/Adaptive-LLM-finetune-Openscene-FLEX-threshold.yaml \
    --exp_name Exp0177_0823_ReproduceExp0162_Pts10k_100k_CaptionData70k_FlexWarmUp20_FlexThreshold127_From[Scratch] \
    --resume
