...
cd /gpfs/u/home/LMCG/LMCGljnn/scratch/zhy/pointbert
    $CMD  main_ALLM.py \
    --launcher slurm \
    --config cfgs/MultiScale_models/nuscenes/Adaptive-LLM-finetune-Openscene-test-FLEX-threshold.yaml \
    --exp_name Exp0176_0823_Pts10k_400k_Token64_FlexWarmUp20_FlexThreshold127_From[Scratch]_Epoch4_CHUNK1 \
    --ckpt experiments/Adaptive-LLM-finetune-Openscene-FLEX-threshold/nuscenes/Exp0176_0823_Pts10k_400k_Token64_FlexWarmUp20_FlexThreshold127_From[Scratch]/ckpt-epoch-003.pth\
    --test 