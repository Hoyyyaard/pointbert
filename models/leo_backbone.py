...
from models.dvae import Encoder, Group
...
class PointBERT(nn.Module):
    def __init__(self, trans_dim, depth, drop_path_rate, cls_dim, 
                 num_heads, group_size, num_group, encoder_dims, add_RGB=False) -> None:
        super().__init__()
